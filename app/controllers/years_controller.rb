class YearsController < ApplicationController
  ...
  def create
     ...
     @city = City.find(params[:year][:city_id])

 
     @year = @city.years.create(year_params)
  ...
  def destroy
    @year.destroy
    respond_to do |format|
      format.html { redirect_to city_url(@year.city_id), notice: 'Year was successfully destroyed.' }
  ...
  private
    ...
    def year_params
      params.require(:year).permit(:period, :ruler_id, :dynasty_id, :city_id, :ye_image)
    end
end
