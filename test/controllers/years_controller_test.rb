...
class YearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post years_url, params: { year: { city_id: @year.city_id, dynasty_id: @year.dynasty_id, period: @year.period, ruler_id: @year.ruler_id } }
    end
  ...
  test "should update year" do
    patch year_url(@year), params: { year: { city_id: @year.city_id, dynasty_id: @year.dynasty_id, period: @year.period, ruler_id: @year.ruler_id } }
