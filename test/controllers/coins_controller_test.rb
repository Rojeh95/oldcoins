...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { city_id: @coin.city_id, co_titel: @coin.co_titel, dynasty_id: @coin.dynasty_id, ruler_id: @coin.ruler_id } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { city_id: @coin.city_id, co_titel: @coin.co_titel, dynasty_id: @coin.dynasty_id, ruler_id: @coin.ruler_id } }
